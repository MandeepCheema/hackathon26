...
| **Settlement** | 10 store-days, **$1,455** unreconciled after modeling fees. | Gaps that are just processor fees / timing. |
| **Three-way match** | 7 policy-aware exceptions, **~$376**. | 4 lines within materiality/tolerance. |
