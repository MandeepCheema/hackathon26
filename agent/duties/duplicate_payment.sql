...
-- Excluded decoys:
--  * recurring same-amount payments with DISTINCT invoices (legitimate cadence)
--  * a re-issued invoice whose original was voided/credited — a CREDIT MEMO on either
--    invoice marks the pair as corrected, not duplicated (world.fin_credit_memos, inv_00295 decoy)
